...
function NicknameScreen({ onStart }) {
  ...
  return (
    <div style={{
      ...
      padding: "2rem", fontFamily: "'Sarabun','Prompt',sans-serif",
    }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <button
            ...
            style={{
              ...
              color: "#fff", fontWeight: 700, fontSize: "1rem", cursor: name.trim() ? "pointer" : "not-allowed",
...
function DoneScreen({ nickname, onRestart }) {
  return (
    <div style={{
      minHeight: "100vh", background: BG,
      display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
      padding: "2rem", fontFamily: "'Sarabun','Prompt',sans-serif", textAlign: "center",
    }}>
      ...
      <p style={{ color: "#8db88a", fontSize: "0.875rem", marginBottom: "1.5rem" }}>
        ขอบคุณที่ใจดีกับตัวเองวันนี้
      </p>
...
function MentalStrength() {
  ...
  const handleRestart = () => {
    setAnswers({}); setCurrent(0); setFlipped(false);
    setNickname(""); setStage("nickname");
  };
  ...
  return (
    <div style={{
      minHeight: "100vh", background: BG,
      display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
      padding: "clamp(1rem,4vw,2rem)", fontFamily: "'Sarabun','Prompt',sans-serif",
    }}>
      <link href="https://fonts.googleapis.com/css2?family=Sarabun:wght@400;600;700&family=Dancing+Script:wght@700&display=swap" rel="stylesheet" />
